    ...
    <div className="container-fluid">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <p>
                  ...
                  <br />
                  3.Will it build GOOD WILL and BETTER FRIENDSHI P<br />
      ...
      <div class="row board">
        <div class="col-md-6">
          <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6">
              <img src={img4} width="150" alt="avator" />
              <h5>President</h5>
              <h5>John Doe</h5>
            </div>
            <div class="col-md-3"></div>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <img src={img5} width="150" height="150" alt="avator" />
              <p>President</p>
            </div>
            <div class="col-md-3">
              <img src={img5} width="150" height="150" alt="avator" />
        ...
        <div class="col-md-6 description">
          <p>
            ...
            do eiusmodLorem ipsum dolor sit amet, consectetur adipiscing elit,{" "}
            <br />
            ...
            sed do eiusmodLorem ipsum dolor sit amet, consectetur adipiscing
            elit, sed do eiusmod sed do eiusmodLorem ipsum dolor sit amet,
      ...
      <div class="row">
        <div class="col-6">
          <h2>
            {" "}
            <span>1</span> Professional development
          </h2>
          <p>
            sed do eiusmodLorem ipsum dolor sit amet, consectetur adipiscing
            elit, sed do eiusmod sed do eiusmodLorem ipsum dolor sit amet,
        ...
        <div class="col-6">
          <h2>
            {" "}
            <span>2</span> Professional development
          </h2>
          <p>
            sed do eiusmodLorem ipsum dolor sit amet, consectetur adipiscing
            elit, sed do eiusmod sed do eiusmodLorem ipsum dolor sit amet,
      ...
      <div class="row">
        <div class="col-6">
          <h2>
            {" "}
            <span>3</span> Professional development
          </h2>
          <p>
            sed do eiusmodLorem ipsum dolor sit amet, consectetur adipiscing
            elit, sed do eiusmod sed do eiusmodLorem ipsum dolor sit amet,
        ...
        <div class="col-6">
          <h2>
            {" "}
            <span>5</span> Professional development
          </h2>
          <p>
            sed do eiusmodLorem ipsum dolor sit amet, consectetur adipiscing
            elit, sed do eiusmod sed do eiusmodLorem ipsum dolor sit amet,
      ...
      <div class="row">
        ...
        <div class="col-6">
          <h2>
            {" "}
            <span>6</span> Professional development
          </h2>
          <p>
            sed do eiusmodLorem ipsum dolor sit amet, consectetur adipiscing
            elit, sed do eiusmod sed do eiusmodLorem ipsum dolor sit amet,
      ...
      <div class="row">
        <div class="col-6">
          <h2>
            {" "}
            <span>7</span> Professional development
          </h2>
          <p>
            sed do eiusmodLorem ipsum dolor sit amet, consectetur adipiscing
            elit, sed do eiusmod sed do eiusmodLorem ipsum dolor sit amet,
